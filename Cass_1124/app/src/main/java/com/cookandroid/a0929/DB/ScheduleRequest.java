...
public class ScheduleRequest extends StringRequest {
    ...
    public ScheduleRequest(String title, String sdate, String edate, String text, String color, String usercode, String groupcode, Response.Listener<String> listener) {
