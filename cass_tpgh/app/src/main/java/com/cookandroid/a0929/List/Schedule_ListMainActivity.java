...
import com.cookandroid.a0929.DB.DelateScheduleRequest;
...
public class Schedule_ListMainActivity extends AppCompatActivity {
    ...
    private void delate_schedule(int schedule_code) {
        ...
        DelateScheduleRequest delateScheduleRequest = new DelateScheduleRequest(schedule_code, responseListener_groupcode);
        RequestQueue queue = Volley.newRequestQueue(Schedule_ListMainActivity.this);
        queue.add(delateScheduleRequest);
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        try {
            ...
            while (count < jsonArray.length()) {
                ...
                //System.out.println("여기"+groupcode);

                //값들을 User클래스에 묶어줍니다
                ListItem list = new ListItem(title, sdate, edate, text, color, writer, groupcode);
